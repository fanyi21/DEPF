...
if nargin < 6
    maxTcutKmIters = 1000; % maxTcutKmIters and cntTcutKmReps are used to limit the iterations of the k-means discretization in Tcut.
end
if nargin < 5
...
% k-means
% maxKmIters = 5000;
labels = kmeans(evec,Nseg,'MaxIter',maxKmIters,'Replicates',cntReps,'OnlinePhase','on');
